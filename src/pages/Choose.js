...
function Choose() {
    return (
        <div>
            <Header />
            <section id="choose-hero" className="pan-background d-flex align-items-center">
                ...
                <div className="container">
                    <div className="row justify-content-center align-items-center">
                        ...
                        <div className="col-lg-6">
                            ...
                            <div className="d-flex certificates-logo align-items-center justify-content-center flex-wrap w-100">
            ...
            <section id="choose-provide" className="pan-background d-flex align-items-center">
                <div className="container">
                    <div className="row justify-content-center align-items-center">
                        <div className="col-lg-6">
                            <h1>We Provide</h1>
            ...
            <section id="choose-service" className="pan-background d-flex align-items-center">
                <div className="container">
                    <div className="row justify-content-center align-items-center">
                        <div className="col-lg-6">
                            <h1>We Offer</h1>
            ...
            <section id="choose-help" className="pan-background d-flex align-items-center">
                <div className="container">
                    <div className="row justify-content-center align-items-center">
                        <div className="col-lg-6">
                            <h1>We Help</h1>
                            ...
                            <p>How do we do this??</p>
                            <h2>We have strategic partnerships with Manufacturing across three continents</h2>
                        </div>
                        <div className="col-lg-6">
