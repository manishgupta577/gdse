        ...
        <div className="container">
          <div className="row justify-content-center align-items-center">
            <div className="col-md-6 my-4">
              <h1>About Us</h1>
              <p>
                GDSeBike has been in existence for a decade, It began with three
                founders passionate about EV industry wanted to bring the best
                product to the world.
              </p>
              <p>
                We Soon saw good success, that we believe was a result of
                serving some great clients and extreme hard work of our team.
              </p>
              <p>
                We felt the need to establish one of the biggest eBike factories
                of the world in Guangdong province, It helped us to scale up
                drastically and we started offering OEM & ODM service.
              </p>
              <p>
                We soon became absolutely specialized in manufacturing medium to
                high-end
              </p>
              <ul>
            ...
            <div className="col-md-6 my-4">
              <h1>Our Factory</h1>
              <p>
                We have full-automatic wheel assembly equipment for 16 sets,
                with the production line over 150 meters.
              </p>
              <p>
                We have highly automater and precise testing equipment for Frame
                Accuracy Testing.
              </p>
              <p>
                We perform Platform Frame Vibration Test for Front Fork Accuracy
                Testing along with Platform Front Fork Fatigue Test using our
                high end Machineries.
              </p>
              <p>
                Our state of the art Precision salt spray testing machine never
                fails to give faulty results.
              </p>
              <p>
                We have Rockwell hardness tests and Dynamometer Controller
                Comprehensive Testing Instrument for Electric Vehicle Parts
                along with Electric cardboard Breakage Resistance tests.
              </p>
              <p>
                We never get a chance to be less proud of our sensional R&D
                team, highly professional sales team, extremely experienced
                production team, super strong technology support team, along
                with the precise and strick quality control team.
              </p>
              <p>
                Our products has been passed EN15194, RoHS, ISO4210, LVD, EMC
                certificates. We are very proud to tell you, the annual sales in
                2020 will exceed 80,000 pcs electric bike and 400,000 pcs normal
                bicycle, 30% of our market is in China mainland, and 70% of our
                market is in Europe, USA, Russia, Middle East, Southeast Asia,
        ...
        <div className="container">
          ...
          <div className="row justify-content-center text-center">
            ...
            <div className="col-md-4 col-sm-6 mb-4">
              ...
              <h2 className="mt-3">Apurv Gore</h2>
              {/* <p>Creative Designer</p> */}
            </div>
          </div>
        </div>
